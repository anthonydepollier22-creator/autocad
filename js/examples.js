...
const EXAMPLES = [
  ...
  },
  {
    ...
    data: {
      ...
      counters: { IN: 4, AFF: 1 },
      components: [
        { id: 'A', type: 'logic_in', x: 0, y: -60, rot: 0, label: 'b1', value: '', high: true },
        { id: 'B', type: 'logic_in', x: 0, y: -20, rot: 0, label: 'b2', value: '', high: false },
        { id: 'C', type: 'logic_in', x: 0, y: 20, rot: 0, label: 'b4', value: '', high: false },
        { id: 'D', type: 'logic_in', x: 0, y: 60, rot: 0, label: 'b8', value: '', high: true },
        { id: 'AFF1', type: 'seven_seg', x: 200, y: 0, rot: 0, label: 'AFF1', value: '' },
      ],
      wires: [
        { id: 'w1', points: [{ x: 40, y: -60 }, { x: 120, y: -60 }, { x: 120, y: -30 }, { x: 160, y: -30 }] },
        { id: 'w2', points: [{ x: 40, y: -20 }, { x: 100, y: -20 }, { x: 100, y: -10 }, { x: 160, y: -10 }] },
        { id: 'w3', points: [{ x: 40, y: 20 }, { x: 100, y: 20 }, { x: 100, y: 10 }, { x: 160, y: 10 }] },
        { id: 'w4', points: [{ x: 40, y: 60 }, { x: 120, y: 60 }, { x: 120, y: 30 }, { x: 160, y: 30 }] },
      ],
    },
  },
  {
