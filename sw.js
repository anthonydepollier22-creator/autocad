...
const CACHE = 'electricad-v10';
const ASSETS = [
  'index.html', 'app.html',
  'css/styles.css', 'css/landing.css',
  'js/symbols.js', 'js/netlist.js', 'js/plan.js', 'js/simulate.js', 'js/digital.js',
  'js/svg.js', 'js/viz3d.js', 'js/gl3d.js', 'js/export3d.js', 'js/examples.js', 'js/houses.js', 'js/install.js', 'js/day.js', 'js/materials.js', 'js/dossier.js',
